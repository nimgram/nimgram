...
method TLEncode*(self: ChannelsReportSpam): seq[uint8] =
    ...
    result = result & TLEncode(self.user_id)
    result = result & TLEncode(self.id)
method TLDecode*(self: ChannelsReportSpam, bytes: var ScalingSeq[uint8]) = 
    var tempObj = new TL
    tempObj.TLDecode(bytes)
    self.channel = cast[InputChannelI](tempObj)
    tempObj.TLDecode(bytes)
...
method TLDecode*(self: ChannelsGetParticipants, bytes: var ScalingSeq[uint8]) = 
    var tempObj = new TL
    tempObj.TLDecode(bytes)
    self.channel = cast[InputChannelI](tempObj)
    tempObj.TLDecode(bytes)
...
method TLDecode*(self: ChannelsCreateChannel, bytes: var ScalingSeq[uint8]) = 
...
method TLDecode*(self: ChannelsEditAdmin, bytes: var ScalingSeq[uint8]) = 
    var tempObj = new TL
    tempObj.TLDecode(bytes)
    self.channel = cast[InputChannelI](tempObj)
    tempObj.TLDecode(bytes)
...
method TLEncode*(self: ChannelsExportMessageLink): seq[uint8] =
    ...
    result = result & TLEncode(self.channel)
    result = result & TLEncode(self.id)
method TLDecode*(self: ChannelsExportMessageLink, bytes: var ScalingSeq[uint8]) = 
    bytes.TLDecode(addr self.flags)
    if (self.flags and (1 shl 0)) != 0:
        self.grouped = true
    if (self.flags and (1 shl 1)) != 0:
...
method TLEncode*(self: ChannelsGetAdminedPublicChannels): seq[uint8] =
    ...
    if self.check_limit:
        self.flags = self.flags or 1 shl 1
    result = result & TLEncode(self.flags)
method TLDecode*(self: ChannelsGetAdminedPublicChannels, bytes: var ScalingSeq[uint8]) = 
    bytes.TLDecode(addr self.flags)
    if (self.flags and (1 shl 0)) != 0:
...
method TLDecode*(self: ChannelsEditBanned, bytes: var ScalingSeq[uint8]) = 
    var tempObj = new TL
    tempObj.TLDecode(bytes)
    self.channel = cast[InputChannelI](tempObj)
    tempObj.TLDecode(bytes)
...
method TLEncode*(self: ChannelsGetAdminLog): seq[uint8] =
    ...
    result = result & TLEncode(self.limit)
method TLDecode*(self: ChannelsGetAdminLog, bytes: var ScalingSeq[uint8]) = 
    bytes.TLDecode(addr self.flags)
    var tempObj = new TL
    tempObj.TLDecode(bytes)
    self.channel = cast[InputChannelI](tempObj)
...
method TLDecode*(self: ChannelsEditCreator, bytes: var ScalingSeq[uint8]) = 
    var tempObj = new TL
    tempObj.TLDecode(bytes)
    self.channel = cast[InputChannelI](tempObj)
    tempObj.TLDecode(bytes)
...
method TLDecode*(self: ChannelsEditLocation, bytes: var ScalingSeq[uint8]) = 
    var tempObj = new TL
    tempObj.TLDecode(bytes)
    self.channel = cast[InputChannelI](tempObj)
    tempObj.TLDecode(bytes)
