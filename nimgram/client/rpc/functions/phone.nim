...
method TLEncode*(self: PhoneGetCallConfig): seq[uint8] =
    result = TLEncode(uint32(1430593449))
method TLDecode*(self: PhoneGetCallConfig, bytes: var ScalingSeq[uint8]) = 
    discard
method TLEncode*(self: PhoneRequestCall): seq[uint8] =
    result = TLEncode(uint32(1124046573))
    if self.video:
...
method TLDecode*(self: PhoneRequestCall, bytes: var ScalingSeq[uint8]) = 
...
method TLEncode*(self: PhoneAcceptCall): seq[uint8] =
    result = TLEncode(uint32(1003664544))
    result = result & TLEncode(self.peer)
    result = result & TLEncode(self.g_b)
    result = result & TLEncode(self.protocol)
method TLDecode*(self: PhoneAcceptCall, bytes: var ScalingSeq[uint8]) = 
    var tempObj = new TL
    tempObj.TLDecode(bytes)
    ...
    tempObj.TLDecode(bytes)
    self.protocol = cast[PhoneCallProtocolI](tempObj)
method TLEncode*(self: PhoneConfirmCall): seq[uint8] =
    result = TLEncode(uint32(788404002))
    result = result & TLEncode(self.peer)
    result = result & TLEncode(self.g_a)
    result = result & TLEncode(self.key_fingerprint)
    result = result & TLEncode(self.protocol)
method TLDecode*(self: PhoneConfirmCall, bytes: var ScalingSeq[uint8]) = 
    var tempObj = new TL
    tempObj.TLDecode(bytes)
    self.peer = cast[InputPhoneCallI](tempObj)
    ...
    tempObj.TLDecode(bytes)
    self.protocol = cast[PhoneCallProtocolI](tempObj)
method TLEncode*(self: PhoneReceivedCall): seq[uint8] =
    result = TLEncode(uint32(399855457))
    result = result & TLEncode(self.peer)
method TLDecode*(self: PhoneReceivedCall, bytes: var ScalingSeq[uint8]) = 
    var tempObj = new TL
    tempObj.TLDecode(bytes)
    self.peer = cast[InputPhoneCallI](tempObj)
method TLEncode*(self: PhoneDiscardCall): seq[uint8] =
    result = TLEncode(uint32(2999697856))
    if self.video:
        self.flags = self.flags or 1 shl 0
    result = result & TLEncode(self.flags)
    result = result & TLEncode(self.peer)
...
method TLDecode*(self: PhoneDiscardCall, bytes: var ScalingSeq[uint8]) = 
    bytes.TLDecode(addr self.flags)
    if (self.flags and (1 shl 0)) != 0:
        self.video = true
    var tempObj = new TL
...
method TLEncode*(self: PhoneSetCallRating): seq[uint8] =
    result = TLEncode(uint32(1508562471))
...
method TLDecode*(self: PhoneSetCallRating, bytes: var ScalingSeq[uint8]) = 
    bytes.TLDecode(addr self.flags)
    if (self.flags and (1 shl 0)) != 0:
...
method TLEncode*(self: PhoneSaveCallDebug): seq[uint8] =
    result = TLEncode(uint32(662363518))
    result = result & TLEncode(self.peer)
    result = result & TLEncode(self.debug)
method TLDecode*(self: PhoneSaveCallDebug, bytes: var ScalingSeq[uint8]) = 
    var tempObj = new TL
    tempObj.TLDecode(bytes)
    self.peer = cast[InputPhoneCallI](tempObj)
    tempObj.TLDecode(bytes)
    self.debug = cast[DataJSONI](tempObj)
method TLEncode*(self: PhoneSendSignalingData): seq[uint8] =
    result = TLEncode(uint32(4286223235))
    result = result & TLEncode(self.peer)
    result = result & TLEncode(self.data)
method TLDecode*(self: PhoneSendSignalingData, bytes: var ScalingSeq[uint8]) = 
    var tempObj = new TL
    tempObj.TLDecode(bytes)
    self.peer = cast[InputPhoneCallI](tempObj)
    self.data = bytes.TLDecode()
method TLEncode*(self: PhoneCreateGroupCall): seq[uint8] =
    result = TLEncode(uint32(3827890690))
    result = result & TLEncode(self.channel)
    result = result & TLEncode(self.random_id)
method TLDecode*(self: PhoneCreateGroupCall, bytes: var ScalingSeq[uint8]) = 
    var tempObj = new TL
    tempObj.TLDecode(bytes)
    self.channel = cast[InputChannelI](tempObj)
    bytes.TLDecode(addr self.random_id)
method TLEncode*(self: PhoneJoinGroupCall): seq[uint8] =
    result = TLEncode(uint32(1604095586))
    if self.muted:
        self.flags = self.flags or 1 shl 0
    result = result & TLEncode(self.flags)
    result = result & TLEncode(self.call)
    result = result & TLEncode(self.params)
method TLDecode*(self: PhoneJoinGroupCall, bytes: var ScalingSeq[uint8]) = 
    bytes.TLDecode(addr self.flags)
    if (self.flags and (1 shl 0)) != 0:
        self.muted = true
    var tempObj = new TL
...
method TLEncode*(self: PhoneLeaveGroupCall): seq[uint8] =
    result = TLEncode(uint32(1342404601))
    result = result & TLEncode(self.call)
    result = result & TLEncode(self.source)
method TLDecode*(self: PhoneLeaveGroupCall, bytes: var ScalingSeq[uint8]) = 
    var tempObj = new TL
    tempObj.TLDecode(bytes)
    self.call = cast[InputGroupCallI](tempObj)
    bytes.TLDecode(addr self.source)
method TLEncode*(self: PhoneEditGroupCallMember): seq[uint8] =
    result = TLEncode(uint32(1662282468))
    if self.muted:
        self.flags = self.flags or 1 shl 0
    result = result & TLEncode(self.flags)
    result = result & TLEncode(self.call)
    result = result & TLEncode(self.user_id)
method TLDecode*(self: PhoneEditGroupCallMember, bytes: var ScalingSeq[uint8]) = 
    bytes.TLDecode(addr self.flags)
    if (self.flags and (1 shl 0)) != 0:
        self.muted = true
    var tempObj = new TL
    ...
    tempObj.TLDecode(bytes)
    self.user_id = cast[InputUserI](tempObj)
method TLEncode*(self: PhoneInviteToGroupCall): seq[uint8] =
    result = TLEncode(uint32(2067345760))
    result = result & TLEncode(self.call)
    result = result & TLEncode(cast[seq[TL]](self.users))
method TLDecode*(self: PhoneInviteToGroupCall, bytes: var ScalingSeq[uint8]) = 
    var tempObj = new TL
    tempObj.TLDecode(bytes)
    self.call = cast[InputGroupCallI](tempObj)
    ...
    tempVector.setLen(0)
method TLEncode*(self: PhoneDiscardGroupCall): seq[uint8] =
    result = TLEncode(uint32(2054648117))
    result = result & TLEncode(self.call)
method TLDecode*(self: PhoneDiscardGroupCall, bytes: var ScalingSeq[uint8]) = 
    var tempObj = new TL
    tempObj.TLDecode(bytes)
    self.call = cast[InputGroupCallI](tempObj)
method TLEncode*(self: PhoneToggleGroupCallSettings): seq[uint8] =
    result = TLEncode(uint32(1958458429))
...
method TLDecode*(self: PhoneToggleGroupCallSettings, bytes: var ScalingSeq[uint8]) = 
    bytes.TLDecode(addr self.flags)
    var tempObj = new TL
    tempObj.TLDecode(bytes)
    self.call = cast[InputGroupCallI](tempObj)
...
method TLEncode*(self: PhoneGetGroupCall): seq[uint8] =
    result = TLEncode(uint32(3351970160))
    result = result & TLEncode(self.call)
method TLDecode*(self: PhoneGetGroupCall, bytes: var ScalingSeq[uint8]) = 
    var tempObj = new TL
    tempObj.TLDecode(bytes)
    self.call = cast[InputGroupCallI](tempObj)
method TLEncode*(self: PhoneGetGroupParticipants): seq[uint8] =
    result = TLEncode(uint32(3388068485))
    result = result & TLEncode(self.call)
...
method TLDecode*(self: PhoneGetGroupParticipants, bytes: var ScalingSeq[uint8]) = 
    var tempObj = new TL
    tempObj.TLDecode(bytes)
    self.call = cast[InputGroupCallI](tempObj)
...
method TLEncode*(self: PhoneCheckGroupCall): seq[uint8] =
    result = TLEncode(uint32(3075111914))
    result = result & TLEncode(self.call)
    result = result & TLEncode(self.source)
method TLDecode*(self: PhoneCheckGroupCall, bytes: var ScalingSeq[uint8]) = 
    var tempObj = new TL
    tempObj.TLDecode(bytes)
    self.call = cast[InputGroupCallI](tempObj)
    bytes.TLDecode(addr self.source)
