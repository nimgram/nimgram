...
method TLEncode*(self: ContactsContactsNotModified): seq[uint8] =
    result = TLEncode(uint32(3075189202))
method TLDecode*(self: ContactsContactsNotModified, bytes: var ScalingSeq[uint8]) = 
    discard
method TLEncode*(self: ContactsContacts): seq[uint8] =
    result = TLEncode(uint32(3941105218))
...
method TLDecode*(self: ContactsContacts, bytes: var ScalingSeq[uint8]) = 
    ...
    tempVector.setLen(0)
method TLEncode*(self: ContactsImportedContacts): seq[uint8] =
    result = TLEncode(uint32(2010127419))
    ...
    result = result & TLEncode(cast[seq[TL]](self.users))
method TLDecode*(self: ContactsImportedContacts, bytes: var ScalingSeq[uint8]) = 
    var tempVector = newSeq[TL]()
    tempVector.TLDecode(bytes)
    ...
    self.users = cast[seq[UserI]](tempVector)
    tempVector.setLen(0)
method TLEncode*(self: ContactsBlocked): seq[uint8] =
    result = TLEncode(uint32(2917226768))
    result = result & TLEncode(cast[seq[TL]](self.blocked))
    result = result & TLEncode(cast[seq[TL]](self.chats))
    result = result & TLEncode(cast[seq[TL]](self.users))
method TLDecode*(self: ContactsBlocked, bytes: var ScalingSeq[uint8]) = 
    var tempVector = newSeq[TL]()
    tempVector.TLDecode(bytes)
    ...
    self.users = cast[seq[UserI]](tempVector)
    tempVector.setLen(0)
method TLEncode*(self: ContactsBlockedSlice): seq[uint8] =
    result = TLEncode(uint32(3781575060))
    result = result & TLEncode(self.count)
    result = result & TLEncode(cast[seq[TL]](self.blocked))
    result = result & TLEncode(cast[seq[TL]](self.chats))
    result = result & TLEncode(cast[seq[TL]](self.users))
method TLDecode*(self: ContactsBlockedSlice, bytes: var ScalingSeq[uint8]) = 
    ...
    self.users = cast[seq[UserI]](tempVector)
    tempVector.setLen(0)
method TLEncode*(self: ContactsFound): seq[uint8] =
    result = TLEncode(uint32(3004386717))
    result = result & TLEncode(cast[seq[TL]](self.my_results))
    result = result & TLEncode(cast[seq[TL]](self.results))
    result = result & TLEncode(cast[seq[TL]](self.chats))
    result = result & TLEncode(cast[seq[TL]](self.users))
method TLDecode*(self: ContactsFound, bytes: var ScalingSeq[uint8]) = 
    var tempVector = newSeq[TL]()
    tempVector.TLDecode(bytes)
    ...
    self.users = cast[seq[UserI]](tempVector)
    tempVector.setLen(0)
method TLEncode*(self: ContactsResolvedPeer): seq[uint8] =
    result = TLEncode(uint32(2131196633))
    result = result & TLEncode(self.peer)
    result = result & TLEncode(cast[seq[TL]](self.chats))
    result = result & TLEncode(cast[seq[TL]](self.users))
method TLDecode*(self: ContactsResolvedPeer, bytes: var ScalingSeq[uint8]) = 
    var tempObj = new TL
    ...
    self.users = cast[seq[UserI]](tempVector)
    tempVector.setLen(0)
method TLEncode*(self: ContactsTopPeersNotModified): seq[uint8] =
    result = TLEncode(uint32(3727060725))
method TLDecode*(self: ContactsTopPeersNotModified, bytes: var ScalingSeq[uint8]) = 
    discard
method TLEncode*(self: ContactsTopPeers): seq[uint8] =
    result = TLEncode(uint32(1891070632))
    result = result & TLEncode(cast[seq[TL]](self.categories))
    result = result & TLEncode(cast[seq[TL]](self.chats))
    result = result & TLEncode(cast[seq[TL]](self.users))
method TLDecode*(self: ContactsTopPeers, bytes: var ScalingSeq[uint8]) = 
    var tempVector = newSeq[TL]()
    tempVector.TLDecode(bytes)
    ...
    self.users = cast[seq[UserI]](tempVector)
    tempVector.setLen(0)
method TLEncode*(self: ContactsTopPeersDisabled): seq[uint8] =
    result = TLEncode(uint32(3039597469))
method TLDecode*(self: ContactsTopPeersDisabled, bytes: var ScalingSeq[uint8]) = 
    discard
