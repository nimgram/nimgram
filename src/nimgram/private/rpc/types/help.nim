...
method TLEncode*(self: HelpAppUpdate): seq[uint8] {.locks: "unknown".} =
...
method TLDecode*(self: HelpAppUpdate, bytes: var ScalingSeq[uint8]) {.locks: "unknown".} = 
...
method TLEncode*(self: HelpNoAppUpdate): seq[uint8] {.locks: "unknown".} =
    result = TLEncode(uint32(0xc45a6536))
method TLDecode*(self: HelpNoAppUpdate, bytes: var ScalingSeq[uint8]) {.locks: "unknown".} = 
    discard
method TLEncode*(self: HelpInviteText): seq[uint8] {.locks: "unknown".} =
    result = TLEncode(uint32(0x18cb9f78))
    result = result & TLEncode(self.message)
method TLDecode*(self: HelpInviteText, bytes: var ScalingSeq[uint8]) {.locks: "unknown".} = 
    self.message = cast[string](bytes.TLDecode())
method TLEncode*(self: HelpSupport): seq[uint8] {.locks: "unknown".} =
    result = TLEncode(uint32(0x17c6b5f6))
    result = result & TLEncode(self.phone_number)
    result = result & TLEncode(self.user)
method TLDecode*(self: HelpSupport, bytes: var ScalingSeq[uint8]) {.locks: "unknown".} = 
    self.phone_number = cast[string](bytes.TLDecode())
    var tempObj = new TL
    tempObj.TLDecode(bytes)
    self.user = cast[UserI](tempObj)
method TLEncode*(self: HelpTermsOfService): seq[uint8] {.locks: "unknown".} =
...
method TLDecode*(self: HelpTermsOfService, bytes: var ScalingSeq[uint8]) {.locks: "unknown".} = 
    bytes.TLDecode(addr self.flags)
    if (self.flags and (1 shl 0)) != 0:
        self.popup = true
    var tempObj = new TL
...
method TLEncode*(self: HelpRecentMeUrls): seq[uint8] {.locks: "unknown".} =
...
method TLDecode*(self: HelpRecentMeUrls, bytes: var ScalingSeq[uint8]) {.locks: "unknown".} = 
    var tempVector = newSeq[TL]()
    tempVector.TLDecode(bytes)
    ...
    tempVector.setLen(0)
method TLEncode*(self: HelpTermsOfServiceUpdateEmpty): seq[uint8] {.locks: "unknown".} =
    result = TLEncode(uint32(0xe3309f7f))
    result = result & TLEncode(self.expires)
method TLDecode*(self: HelpTermsOfServiceUpdateEmpty, bytes: var ScalingSeq[uint8]) {.locks: "unknown".} = 
    bytes.TLDecode(addr self.expires)
method TLEncode*(self: HelpTermsOfServiceUpdate): seq[uint8] {.locks: "unknown".} =
    result = TLEncode(uint32(0x28ecf961))
    result = result & TLEncode(self.expires)
    result = result & TLEncode(self.terms_of_service)
method TLDecode*(self: HelpTermsOfServiceUpdate, bytes: var ScalingSeq[uint8]) {.locks: "unknown".} = 
    bytes.TLDecode(addr self.expires)
    var tempObj = new TL
    tempObj.TLDecode(bytes)
    self.terms_of_service = cast[HelpTermsOfServiceI](tempObj)
method TLEncode*(self: HelpDeepLinkInfoEmpty): seq[uint8] {.locks: "unknown".} =
    result = TLEncode(uint32(0x66afa166))
method TLDecode*(self: HelpDeepLinkInfoEmpty, bytes: var ScalingSeq[uint8]) {.locks: "unknown".} = 
    discard
method TLEncode*(self: HelpDeepLinkInfo): seq[uint8] {.locks: "unknown".} =
...
method TLDecode*(self: HelpDeepLinkInfo, bytes: var ScalingSeq[uint8]) {.locks: "unknown".} = 
    bytes.TLDecode(addr self.flags)
    if (self.flags and (1 shl 0)) != 0:
...
method TLEncode*(self: HelpPassportConfigNotModified): seq[uint8] {.locks: "unknown".} =
    result = TLEncode(uint32(0xbfb9f457))
method TLDecode*(self: HelpPassportConfigNotModified, bytes: var ScalingSeq[uint8]) {.locks: "unknown".} = 
    discard
method TLEncode*(self: HelpPassportConfig): seq[uint8] {.locks: "unknown".} =
    result = TLEncode(uint32(0xa098d6af))
    result = result & TLEncode(self.hash)
    result = result & TLEncode(self.countries_langs)
method TLDecode*(self: HelpPassportConfig, bytes: var ScalingSeq[uint8]) {.locks: "unknown".} = 
    bytes.TLDecode(addr self.hash)
    var tempObj = new TL
    tempObj.TLDecode(bytes)
    self.countries_langs = cast[DataJSONI](tempObj)
method TLEncode*(self: HelpSupportName): seq[uint8] {.locks: "unknown".} =
    result = TLEncode(uint32(0x8c05f1c9))
    result = result & TLEncode(self.name)
method TLDecode*(self: HelpSupportName, bytes: var ScalingSeq[uint8]) {.locks: "unknown".} = 
    self.name = cast[string](bytes.TLDecode())
method TLEncode*(self: HelpUserInfoEmpty): seq[uint8] {.locks: "unknown".} =
    result = TLEncode(uint32(0xf3ae2eed))
method TLDecode*(self: HelpUserInfoEmpty, bytes: var ScalingSeq[uint8]) {.locks: "unknown".} = 
    discard
method TLEncode*(self: HelpUserInfo): seq[uint8] {.locks: "unknown".} =
    result = TLEncode(uint32(0x1eb3758))
    result = result & TLEncode(self.message)
    result = result & TLEncode(cast[seq[TL]](self.entities))
    result = result & TLEncode(self.author)
    result = result & TLEncode(self.date)
method TLDecode*(self: HelpUserInfo, bytes: var ScalingSeq[uint8]) {.locks: "unknown".} = 
    self.message = cast[string](bytes.TLDecode())
    var tempVector = newSeq[TL]()
    tempVector.TLDecode(bytes)
    self.entities = cast[seq[MessageEntityI]](tempVector)
...
method TLEncode*(self: HelpPromoDataEmpty): seq[uint8] {.locks: "unknown".} =
    result = TLEncode(uint32(0x98f6ac75))
    result = result & TLEncode(self.expires)
method TLDecode*(self: HelpPromoDataEmpty, bytes: var ScalingSeq[uint8]) {.locks: "unknown".} = 
    bytes.TLDecode(addr self.expires)
method TLEncode*(self: HelpPromoData): seq[uint8] {.locks: "unknown".} =
...
method TLDecode*(self: HelpPromoData, bytes: var ScalingSeq[uint8]) {.locks: "unknown".} = 
    bytes.TLDecode(addr self.flags)
    if (self.flags and (1 shl 0)) != 0:
        self.proxy = true
    bytes.TLDecode(addr self.expires)
...
method TLEncode*(self: HelpCountryCode): seq[uint8] {.locks: "unknown".} =
...
method TLDecode*(self: HelpCountryCode, bytes: var ScalingSeq[uint8]) {.locks: "unknown".} = 
    bytes.TLDecode(addr self.flags)
...
method TLEncode*(self: HelpCountry): seq[uint8] {.locks: "unknown".} =
...
method TLDecode*(self: HelpCountry, bytes: var ScalingSeq[uint8]) {.locks: "unknown".} = 
    bytes.TLDecode(addr self.flags)
    if (self.flags and (1 shl 0)) != 0:
        self.hidden = true
    ...
    tempVector.setLen(0)
method TLEncode*(self: HelpCountriesListNotModified): seq[uint8] {.locks: "unknown".} =
    result = TLEncode(uint32(0x93cc1f32))
method TLDecode*(self: HelpCountriesListNotModified, bytes: var ScalingSeq[uint8]) {.locks: "unknown".} = 
    discard
method TLEncode*(self: HelpCountriesList): seq[uint8] {.locks: "unknown".} =
    result = TLEncode(uint32(0x87d0759e))
    result = result & TLEncode(cast[seq[TL]](self.countries))
    result = result & TLEncode(self.hash)
method TLDecode*(self: HelpCountriesList, bytes: var ScalingSeq[uint8]) {.locks: "unknown".} = 
    var tempVector = newSeq[TL]()
    tempVector.TLDecode(bytes)
